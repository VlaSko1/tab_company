...
$this->addExternalCss($this->GetFolder() . '/lib/fias-api/src/css/style.css');
$this->addExternalCss($this->GetFolder() . '/lib/Datepicker/dist/css/datepicker.material.css');
$this->addExternalJS($this->GetFolder() . '/lib/fias-api/src/js/core.js');
$this->addExternalJS($this->GetFolder() . '/lib/fias-api/src/js/fias.js');
$this->addExternalJS($this->GetFolder() . '/lib/Datepicker/dist/datepicker.js');
